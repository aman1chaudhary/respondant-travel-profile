...
const ModeChoice = () => {
    ...
    function modetransferimg(transimg) {
        const transtype_img = {
            0: "https://static.vecteezy.com/system/resources/previews/004/433/862/original/bus-icon-with-front-view-public-transportation-station-symbol-for-location-plan-free-vector.jpg",
            1: "https://as1.ftcdn.net/v2/jpg/03/13/19/44/1000_F_313194410_c9YTxm37veq50GR2d0TgXEQTfIT3Asvc.jpg",
        };
        ...
        <div>
            <header id="head">
                <div className="banner-content">
                    ...
                    <h2>The most frequently used means of travel from your home to work location: {QuestionResponse.travelMode} </h2><br/>
                    <h2>The total distance between your home and workplace:  {QuestionResponse.distance}</h2><br/>
                    ...
                    <table>
                        <tbody>
                            <tr>
                                <td>{modetransfer(sampleData[0][mode1.mode_attr + '_trans'])}<br /> <img src={modetransferimg(sampleData[0][mode1.mode_attr + '_trans'])} /><br />
                                    {sampleData[0][mode1.mode_attr + '_ivtt']} min</td>
                                <td>{modetransfer(sampleData[0][mode2.mode_attr + '_trans'])}<br /> <img src={modetransferimg(sampleData[0][mode2.mode_attr + '_trans'])} /><br />{sampleData[0][mode2.mode_attr + '_ivtt']} min</td>
                                <td><img src={mode3.icon_link} /><br />{sampleData[0][mode3.mode_attr + '_ivtt']} min</td>
                                <td><img src={mode4.icon_link} /><br />{sampleData[0][mode4.mode_attr + '_ivtt']} min</td>
                                <td><img src={mode5.icon_link} /><br />{sampleData[0][mode5.mode_attr + '_ivtt']} min</td>
                            </tr>
                        </tbody>
                    </table>
